...
class WontonBot:
    def __init__(self):
        ...
        self.query_file = 'data.txt'
        self.api_url_base = "https://wonton.food/api/v1"
        self.header_base = {
    ...
    def banner(self):
        ...
        print(Fore.RED + '[#] MRPLANKTN    ' + Fore.GREEN + '[WONTON] $$ ' + Fore.RESET)
        print(Fore.GREEN + '[#] Welcome & Enjoy !', Fore.RESET)
        print(Fore.YELLOW + '[#] Having Troubles? PM Telegram [t.me/mrplanktn]', Fore.RESET)
        print('')
    ...
    def perform_tasks(self, token):
        ...
        print(f"{Fore.WHITE}-==========[github.com/mrplanktn/wonton]==========-{Fore.RESET}")
    ...
    def run(self):
        try:
            ...
            timestamp = Fore.MAGENTA + get_formatted_time() + Fore.RESET
            print(f"[{timestamp}] - {Fore.RED}Exiting WONTON BOT...{Fore.RESET}")
            sys.exit()
